...
const BOTNAME = 'ODS TECHNOLOGIES|-WA-BOT™';
const FOOTERNAME = '> ODS TECHNOLOGIES';
global.owner = process.env.OWNER_NUMBER  || '233596780685' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=vFERWYKR#6CT5g7NRiIcR6ac2m0J85quuBB8-H7rElkeQRwOlwBM' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "233596780685" : process.env.MODERATORS ,    
...
FOOTER: process.env.FOOTER || '‌👨‍💻 ODS TECHNOLOGIES 👨‍💻',    
